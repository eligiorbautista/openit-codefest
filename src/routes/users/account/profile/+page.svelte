    ...
    <div class="grid lg:grid-cols-3 gap-8">
        ...
        >
          <div class="text-center">
            ...
            <div class="space-y-3">
              ...
              <button
                class="w-full bg-white hover:bg-gray-50 text-gray-700 border-2 border-gray-200 hover:border-svelte-primary rounded-lg sm:rounded-xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-200 font-semibold flex items-center justify-center gap-2"
              >
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        >
          ...
          <div
            class="flex items-start gap-4 p-4 sm:p-6 bg-gray-50 rounded-lg sm:rounded-xl border border-gray-200 hover:border-svelte-primary hover:bg-white transition-all duration-200"
          >
